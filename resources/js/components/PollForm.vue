...
<div class="max-w-lg space-y-4 w-full px-2">
  ...
  <div class="space-y-2 rounded-lg border border-gray-200 p-4">
    ...
    <div class="flex items-center gap-2">
      <input type="checkbox" id="allowVoteChange"
    ...
    <div class="flex items-center gap-2">
      <input type="checkbox" id="resultsPublic"
    ...
    <div class="flex items-center gap-2 pt-1">
      <input type="number" id="duration"
        :value="duration"
        @input="emit('update:duration', $event.target.value ? Number($event.target.value) : null)"
        min="1"
